...
## ⚡ Fast Access Navigation & All Module READMEs

> 🚀 **Direct Access Hub**: Click on any module's **README Guide** for full concept breakdowns, mental models, and dry-runs, or open its **Source Folder** directly.

| Tier | Module # | Topic & Focus Area | 📖 Module README Guide | 📁 Source Folder |
| :---: | :---: | :--- | :--- | :--- |
| 🗂️ **Global** | — | **Source Directory Hub** | [📖 `src/README.md`](src/README.md) | [`src/`](src/) |
| 🟢 **Beginner** | **01** | Basics, Anatomy & JVM Flow | [📖 Getting Started Guide](src/beginner/getting_started/README.md) | [`src/beginner/getting_started/`](src/beginner/getting_started/) |
| 🟢 **Beginner** | **02** | Variables, Data Types & Primitives | [📖 Variables Guide](src/beginner/variables/README.md) | [`src/beginner/variables/`](src/beginner/variables/) |
| 🟢 **Beginner** | **03** | Type Conversions & Casting | [📖 Type Conversion Guide](src/beginner/type_conversion/README.md) | [`src/beginner/type_conversion/`](src/beginner/type_conversion/) |
| 🟢 **Beginner** | **04** | Operators & Precedence | [📖 Operators Guide](src/beginner/operators/README.md) | [`src/beginner/operators/`](src/beginner/operators/) |
| 🟢 **Beginner** | **05** | Terminal I/O & Scanner Buffer | [📖 Input / Output Guide](src/beginner/input_output/README.md) | [`src/beginner/input_output/`](src/beginner/input_output/) |
| 🟢 **Beginner** | **06** | Conditionals, If-Else & Switch | [📖 Conditionals Guide](src/beginner/conditional_statements/README.md) | [`src/beginner/conditional_statements/`](src/beginner/conditional_statements/) |
| 🟢 **Beginner** | **07** | Loops (for, while, do-while) | [📖 Loops Guide](src/beginner/loops/README.md) | [`src/beginner/loops/`](src/beginner/loops/) |
| 🟢 **Beginner** | **08** | Math API & Random Numbers | [📖 Math & Random Guide](src/beginner/math_and_random/README.md) | [`src/beginner/math_and_random/`](src/beginner/math_and_random/) |
| 🟡 **Intermediate** | **09** | Mini-Projects & Applied Logic | [📖 Practice Projects Guide](src/intermediate/practice_projects/README.md) | [`src/intermediate/practice_projects/`](src/intermediate/practice_projects/) |
| 🟡 **Intermediate** | **10** | Arrays (1D, 2D, 3D, Jagged, Objects) | [📖 Arrays Guide](src/intermediate/arrays/README.md) | [`src/intermediate/arrays/`](src/intermediate/arrays/) |
| 🟡 **Intermediate** | **11** | Methods & Method Overloading | [📖 Methods Guide](src/intermediate/methods/README.md) | [`src/intermediate/methods/`](src/intermediate/methods/) |
| 🟡 **Intermediate** | **12** | Strings & String Constant Pool | [📖 Strings Roadmap](src/intermediate/strings/README.md) | [`src/intermediate/strings/`](src/intermediate/strings/) |
| 🟡 **Intermediate** | **13** | Exception Handling & Robust Systems | [📖 Exceptions Roadmap](src/intermediate/exception_handling/README.md) | [`src/intermediate/exception_handling/`](src/intermediate/exception_handling/) |
| 🔴 **Advanced** | **14** | OOP Basics, Classes & Heap/Stack | [📖 OOP Basics Guide](src/advanced/oop_basics/README.md) | [`src/advanced/oop_basics/`](src/advanced/oop_basics/) |
| 🔴 **Advanced** | **15** | Four Pillars of OOP | [📖 OOP Pillars Roadmap](src/advanced/oop_pillars/README.md) | [`src/advanced/oop_pillars/`](src/advanced/oop_pillars/) |
| 🔴 **Advanced** | **16** | Collections Framework (JCF) | [📖 Collections Roadmap](src/advanced/collections/README.md) | [`src/advanced/collections/`](src/advanced/collections/) |
| 🔴 **Advanced** | **17** | Generics & Type Safety | [📖 Generics Roadmap](src/advanced/generics/README.md) | [`src/advanced/generics/`](src/advanced/generics/) |
| 🔴 **Advanced** | **18** | File I/O & Serialization | [📖 File I/O Roadmap](src/advanced/file_io/README.md) | [`src/advanced/file_io/`](src/advanced/file_io/) |
| 🔴 **Advanced** | **19** | Multithreading & Concurrency | [📖 Concurrency Roadmap](src/advanced/multithreading/README.md) | [`src/advanced/multithreading/`](src/advanced/multithreading/) |
| 🔴 **Advanced** | **20** | Capstone Real-World Projects | [📖 Capstone Roadmap](src/advanced/advanced_projects/README.md) | [`src/advanced/advanced_projects/`](src/advanced/advanced_projects/) |

---

## 📑 Table of Contents

- [⚡ Fast Access Navigation & All Module READMEs](#-fast-access-navigation--all-module-readmes)
...
| :---: | :--- | :--- | :--- | :--- | :--- |
| **01** | **Basics** | [📖 Module 01 Guide](src/beginner/getting_started/README.md) | [`startingstructure.java`](src/beginner/getting_started/startingstructure.java) | `class`, `public static void main`, `System.out.println` entry point | `java -cp out beginner.getting_started.startingstructure` |
| **01** | **Basics** | [📖 Module 01 Guide](src/beginner/getting_started/README.md) | [`OrderDemo.java`](src/beginner/operators/OrderDemo.java) | Operator precedence, BODMAS/PEMDAS, integer division | `java -cp out beginner.operators.OrderDemo` |
| **01** | **Basics** | [📖 Module 01 Guide](src/beginner/getting_started/README.md) | [`scanner.java`](src/beginner/input_output/scanner.java) | `Scanner` setup, terminal reading, buffer management | `java -cp out beginner.input_output.scanner` |
| **02** | **Variables** | [📖 Module 02 Guide](src/beginner/variables/README.md) | [`variables.java`](src/beginner/variables/variables.java) | `int`, `double`, `Boolean`, `String`, concatenation `+` | `java -cp out beginner.variables.variables` |
| **03** | **Conversions** | [📖 Module 03 Guide](src/beginner/type_conversion/README.md) | [`Typepromotions.java`](src/beginner/type_conversion/Typepromotions.java) | Byte multiplication promotion to `int` in expressions | `java -cp out beginner.type_conversion.Typepromotions` |
| **03** | **Conversions** | [📖 Module 03 Guide](src/beginner/type_conversion/README.md) | [`Floatconversion.java`](src/beginner/type_conversion/Floatconversion.java) | Narrowing `(int)` cast & decimal truncation | `java -cp out beginner.type_conversion.Floatconversion` |
| **03** | **Conversions** | [📖 Module 03 Guide](src/beginner/type_conversion/README.md) | [`byteconversion.java`](src/beginner/type_conversion/byteconversion.java) | Explicit casting & 8-bit two's complement overflow wrap | `java -cp out beginner.type_conversion.byteconversion` |
| **04** | **Operators** | [📖 Module 04 Guide](src/beginner/operators/README.md) | [`arithmeticoperator.java`](src/beginner/operators/arithmeticoperator.java) | Arithmetic (`+`, `-`, `*`, `/`, `%`), quotient vs remainder | `java -cp out beginner.operators.arithmeticoperator` |
| **04** | **Operators** | [📖 Module 04 Guide](src/beginner/operators/README.md) | [`increment.java`](src/beginner/operators/increment.java) | Postfix (`i++`) vs Prefix (`++i`) assignment timing | `java -cp out beginner.operators.increment` |
| **04** | **Operators** | [📖 Module 04 Guide](src/beginner/operators/README.md) | [`augmentedassigment.java`](src/beginner/operators/augmentedassigment.java) | Compound updates (`+=`, `-=`, `*=`, `/=`, `%=`) & implicit cast | `java -cp out beginner.operators.augmentedassigment` |
| **04** | **Operators** | [📖 Module 04 Guide](src/beginner/operators/README.md) | [`Relationaloperator.java`](src/beginner/operators/Relationaloperator.java) | Comparison boolean results (`<`, `>`, `==`, `!=`, `<=`, `>=`) | `java -cp out beginner.operators.Relationaloperator` |
| **04** | **Operators** | [📖 Module 04 Guide](src/beginner/operators/README.md) | [`logicaloperator.java`](src/beginner/operators/logicaloperator.java) | Logical AND (`&&`), OR (`\|\|`), NOT (`!`), short-circuiting | `java -cp out beginner.operators.logicaloperator` |
| **05** | **Input/Output**| [📖 Module 05 Guide](src/beginner/input_output/README.md) | [`ScannerInput.java`](src/beginner/input_output/ScannerInput.java) | Multi-type interactive input flow & memory cleanup | `java -cp out beginner.input_output.ScannerInput` |
| **06** | **Conditionals**| [📖 Module 06 Guide](src/beginner/conditional_statements/README.md) | [`ifstatement.java`](src/beginner/conditional_statements/ifstatement.java) | Interactive input validation, `isEmpty()`, age branching | `java -cp out beginner.conditional_statements.ifstatement` |
| **06** | **Conditionals**| [📖 Module 06 Guide](src/beginner/conditional_statements/README.md) | [`ifelse_statement.java`](src/beginner/conditional_statements/ifelse_statement.java) | Two-way decision branching (`if - else`) | `java -cp out beginner.conditional_statements.ifelse_statement` |
| **06** | **Conditionals**| [📖 Module 06 Guide](src/beginner/conditional_statements/README.md) | [`if_else_if.java`](src/beginner/conditional_statements/if_else_if.java) | Multi-condition ladder vs independent `if` statements | `java -cp out beginner.conditional_statements.if_else_if` |
| **06** | **Conditionals**| [📖 Module 06 Guide](src/beginner/conditional_statements/README.md) | [`Ternary_operator.java`](src/beginner/conditional_statements/Ternary_operator.java) | Inline conditional expression `(cond) ? val1 : val2` | `java -cp out beginner.conditional_statements.Ternary_operator` |
| **06** | **Conditionals**| [📖 Module 06 Guide](src/beginner/conditional_statements/README.md) | [`switch_operator.java`](src/beginner/conditional_statements/switch_operator.java) | Classic `switch` with `break` vs modern Java 14+ arrow switch | `java -cp out beginner.conditional_statements.switch_operator` |
| **07** | **Loops** | [📖 Module 07 Guide](src/beginner/loops/README.md) | [`For_loop.java`](src/beginner/loops/For_loop.java) | Counting `for` loop & nested schedule loop traversal | `java -cp out beginner.loops.For_loop` |
| **07** | **Loops** | [📖 Module 07 Guide](src/beginner/loops/README.md) | [`while_loop.java`](src/beginner/loops/while_loop.java) | Pre-condition iteration & loop counter management | `java -cp out beginner.loops.while_loop` |
| **07** | **Loops** | [📖 Module 07 Guide](src/beginner/loops/README.md) | [`Do_while_loop.java`](src/beginner/loops/Do_while_loop.java) | Post-condition loop guaranteed to execute at least once | `java -cp out beginner.loops.Do_while_loop` |
| **08** | **Math & Random**| [📖 Module 08 Guide](src/beginner/math_and_random/README.md) | [`math.java`](src/beginner/math_and_random/math.java) | `Math.PI`, `Math.E`, `sqrt`, `pow`, `abs`, `round`, `ceil` | `java -cp out beginner.math_and_random.math` |
| **08** | **Math & Random**| [📖 Module 08 Guide](src/beginner/math_and_random/README.md) | [`randomnumbers.java`](src/beginner/math_and_random/randomnumbers.java) | `Random.nextInt(origin, bound)`, dice rolls, booleans | `java -cp out beginner.math_and_random.randomnumbers` |

### 🟡 Intermediate Tier (`src/intermediate/`)

| Module # | Topic Name | Module Guide Link | Source File | Core Concepts & Purpose | Quick Run Command |
| :---: | :--- | :--- | :--- | :--- | :--- |
| **09** | **Practice Projects** | [📖 Module 09 Guide](src/intermediate/practice_projects/README.md) | [`shoppingcart.java`](src/intermediate/practice_projects/shoppingcart.java) | Interactive retail billing simulation with currency formatting | `java -cp out intermediate.practice_projects.shoppingcart` |
| **09** | **Practice Projects** | [📖 Module 09 Guide](src/intermediate/practice_projects/README.md) | [`calculaterectangle.java`](src/intermediate/practice_projects/calculaterectangle.java) | Rectangle geometry computation ($Area = w \times h$) | `java -cp out intermediate.practice_projects.calculaterectangle` |
| **09** | **Practice Projects** | [📖 Module 09 Guide](src/intermediate/practice_projects/README.md) | [`for_loop.java`](src/intermediate/practice_projects/for_loop.java) | Dynamic multiplication table generator (Table of 17) | `java -cp out intermediate.practice_projects.for_loop` |
| **10** | **Arrays** | [📖 Module 10 Guide](src/intermediate/arrays/README.md) | [`demo_array.java`](src/intermediate/arrays/demo_array.java) | Inline array initialization, index-based access | `java -cp out intermediate.arrays.demo_array` |
| **10** | **Arrays** | [📖 Module 10 Guide](src/intermediate/arrays/README.md) | [`array_of_elments.java`](src/intermediate/arrays/array_of_elments.java) | `new int[4]` allocation, manual element assignment, `for` loop | `java -cp out intermediate.arrays.array_of_elments` |
| **10** | **Arrays** | [📖 Module 10 Guide](src/intermediate/arrays/README.md) | [`multi_dimensional_array.java`](src/intermediate/arrays/multi_dimensional_array.java) | 2D `int[3][4]` grid, `Math.random()` fill, enhanced for-each | `java -cp out intermediate.arrays.multi_dimensional_array` |
| **10** | **Arrays** | [📖 Module 10 Guide](src/intermediate/arrays/README.md) | [`three_dimensional_array.java`](src/intermediate/arrays/three_dimensional_array.java) | 3D `int[3][4][5]` layered array, 3-level nested loops | `java -cp out intermediate.arrays.three_dimensional_array` |
| **10** | **Arrays** | [📖 Module 10 Guide](src/intermediate/arrays/README.md) | [`jagged_array.java`](src/intermediate/arrays/jagged_array.java) | Jagged `int[3][]` with irregular rows (3, 6, 4), `.length` bounds | `java -cp out intermediate.arrays.jagged_array` |
| **10** | **Arrays** | [📖 Module 10 Guide](src/intermediate/arrays/README.md) | [`Student_array_demo.java`](src/intermediate/arrays/Student_array_demo.java) | Object reference arrays (`Student[]`), instance attributes | `java -cp out intermediate.arrays.Student_array_demo` |
| **11** | **Methods** | [📖 Module 11 Guide](src/intermediate/methods/README.md) | [`Demo_class.java`](src/intermediate/methods/Demo_class.java) | `void` vs return methods, conditional returns, method calls | `java -cp out intermediate.methods.Demo_class` |
| **11** | **Methods** | [📖 Module 11 Guide](src/intermediate/methods/README.md) | [`MethodOverloading.java`](src/intermediate/methods/MethodOverloading.java) | Compile-time polymorphism with overloaded parameter lists | `java -cp out intermediate.methods.MethodOverloading` |
| **12** | **Strings** | [📖 Strings Roadmap](src/intermediate/strings/README.md) | *(Roadmap)* | String Pool, immutability, `StringBuilder` vs `StringBuffer` | *(Roadmap)* |
| **13** | **Exceptions** | [📖 Exceptions Roadmap](src/intermediate/exception_handling/README.md) | *(Roadmap)* | `try-catch-finally`, checked vs unchecked exceptions | *(Roadmap)* |

### 🔴 Advanced Tier (`src/advanced/`)

| Module # | Topic Name | Module Guide Link | Source File | Core Concepts & Purpose | Quick Run Command |
| :---: | :--- | :--- | :--- | :--- | :--- |
| **14** | **OOP Basics** | [📖 OOP Guide](src/advanced/oop_basics/README.md) | [`Classes.java`](src/advanced/oop_basics/Classes.java) | Blueprint `class`, object instantiation `new`, method calls | `java -cp out advanced.oop_basics.Classes` |
| **14** | **OOP Basics** | [📖 OOP Guide](src/advanced/oop_basics/README.md) | [`Stack_Heap_data.java`](src/advanced/oop_basics/Stack_Heap_data.java) | Multiple object instances, independent state, Stack vs Heap | `java -cp out advanced.oop_basics.Stack_Heap_data` |
| **15** | **OOP Pillars** | [📖 Pillars Roadmap](src/advanced/oop_pillars/README.md) | *(Roadmap)* | Encapsulation, inheritance, polymorphism, abstraction | *(Roadmap)* |
| **16** | **Collections** | [📖 Collections Roadmap](src/advanced/collections/README.md) | *(Roadmap)* | `List`, `Set`, `Map`, `Queue`, iterators, Streams | *(Roadmap)* |
| **17** | **Generics** | [📖 Generics Roadmap](src/advanced/generics/README.md) | *(Roadmap)* | Generics, wildcards, type safety, type erasure | *(Roadmap)* |
| **18** | **File I/O** | [📖 File I/O Roadmap](src/advanced/file_io/README.md) | *(Roadmap)* | Byte/character streams, NIO.2 `Files`, serialization | *(Roadmap)* |
| **19** | **Multithreading**| [📖 Concurrency Roadmap](src/advanced/multithreading/README.md) | *(Roadmap)* | `Thread`, `Runnable`, synchronization, `ExecutorService` | *(Roadmap)* |
| **20** | **Capstone** | [📖 Projects Roadmap](src/advanced/advanced_projects/README.md) | *(Roadmap)* | Integrated real-world CLI projects | *(Roadmap)* |
