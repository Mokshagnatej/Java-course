...
| :--- | :--- | :--- | :--- |
| [`Typepromotions.java`](file:///Users/honeyreddy/Documents/Java%20course/src/type_conversions/Typepromotions.java) | Automatic expression promotion (`byte * byte -> int`) | Shows that `byte * byte` produces an `int` result | `java -cp out type_conversions.Typepromotions` |
| [`Floatconversion.java`](file:///Users/honeyreddy/Documents/Java%20course/src/type_conversions/Floatconversion.java) | Explicit casting `(int)` from float and decimal truncation | Shows decimal values being truncated to whole numbers | `java -cp out type_conversions.Floatconversion` |
| [`byteconversion.java`](file:///Users/honeyreddy/Documents/Java%20course/src/type_conversions/byteconversion.java) | Int to byte narrowing, bits truncation & overflow wrap-around | Demonstrates value wrap-around (e.g., 130 → -126) | `java -cp out type_conversions.byteconversion` |
