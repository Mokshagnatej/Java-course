...
| :--- | :--- | :--- | :--- |
| [`variables.java`](file:///Users/honeyreddy/Documents/Java%20course/src/variables/variables.java) | `int`, `double`, `Boolean`, `String`, branching with boolean flags, string concatenation | Prints variable values with concatenated labels<br>(e.g., `"Age: 20"`, `"Height: 3.53"`, `"Name: sai"`) | `java -cp out variables.variables` |
